                    ...
                    onPressed: () {
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          return _TicketCountDialog(qrCode: qrCode);
                        },
                      );
                    },
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            const Text('Please Enter the Scanned Normal Tickets', style: TextStyle(fontSize: 16)),
            TextField(
            ...
            const SizedBox(height: 10),
            const Text('Please Enter the Scanned VIP Tickets', style: TextStyle(fontSize: 16)),
            TextField(
            ...
            const SizedBox(height: 10),
            const Text('Please Enter the Scanned VVIP Tickets', style: TextStyle(fontSize: 16)),
            TextField(
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                var ticketData = {
                  ...
                  'normal_tickets': int.parse(normalTickets),
                  'vip_tickets': int.parse(vipTickets),
                  'vvip_tickets': int.parse(vvipTickets),
